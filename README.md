...
- Added README.md with domain and problem statement.
- Linked Kaggle dataset.

### Week 2
- Cleaned dataset (handled missing values).
- Documented dataset features and importance.
- Added dataset explanation in README.

### Week 3
- Implemented Logistic Regression baseline model.
- Compared accuracy with Decision Tree.
- Logged results in README.

### Week 4
- Applied Random Forest and Gradient Boosting.
- Used SHAP values for feature importance.
- Drafted conclusion section.

### Week 5
- Prepared References section in APA style.
- Updated README with inline citations.
- Finalized proposal structure.
